define(['exports'], function (t) {
	...
	class v {
		...
		async cacheMatch(t) {
			...
			for (const t of this.iterateCallbacks('cachedResponseWillBeUsed'))
				s =
					(await t({cacheName: n, matchOptions: r, cachedResponse: s, request: i, event: this.event})) ||
					void 0;
			return s;
		}
		async cachePut(t, e) {
	...
	class R {
		...
		async D(t, e, s, n) {
			...
			if (
				(await e.runCallbacks('handlerDidComplete', {event: n, request: s, response: r, error: i}),
				e.destroy(),
				i)
			)
				throw i;
