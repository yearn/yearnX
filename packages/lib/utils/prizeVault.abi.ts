export const PRIZE_VAULT_ABI = [
	...
	{inputs: [{internalType: 'uint256', name: 'excess', type: 'uint256'}], name: 'MintLimitExceeded', type: 'error'},
	...
	{
		anonymous: false,
		inputs: [{indexed: false, internalType: 'uint256', name: 'yieldFeePercentage', type: 'uint256'}],
		name: 'YieldFeePercentageSet',
		type: 'event'
	},
	{
		anonymous: false,
		inputs: [{indexed: true, internalType: 'address', name: 'yieldFeeRecipient', type: 'address'}],
