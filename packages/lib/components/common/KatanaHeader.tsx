...
export function KatanaHeader({secondLogoURL}: TKatanaHeader): ReactElement {
	...
	return (
		<div className={'bg-table rounded-3xl px-4 py-2'}>
				...
				<div className={'flex items-center gap-10'}>
					...
					<div className={'flex items-center gap-2'}>
						...
						<button
							...
							className={
								'rounded-lg border border-white bg-white p-3 text-sm font-bold text-black md:px-[30px]'
							}>
			...
			<RewardsModal
				...
				onClose={() => set_isRewardsModalOpen(false)}
			/>
		</div>
	);
}
